...
For HTML, we will always declare the document type at the beginning (for example, <!DOCTYPE>). We will use lowercase element names, as this is the industry standard, and we will open and close all elements on different lines.
